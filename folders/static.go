...
// I assume this function is trying to mock an API call which usually returns a status + data if the status is OK
// Since there is no API to call, but certain functions we use like io.ReadAll and json.Unmarshal may return errors
// I decided to check and return those errors
